...
@Single
class BrokerServiceImpl(private val brokerCall: BrokerCallService) : BrokerService {

    private val log by logger()

    override suspend fun deleteQueueByName(name: String) {
        brokerCall.deleteQueueByName(name = name)
    }

    override suspend fun resetBroker() {
        resetQueues()
        resetTopics()
