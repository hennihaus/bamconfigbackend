...
import de.hennihaus.repositories.tables.StatisticTableDescription.STATISTIC_UPDATED_COLUMN
...
import de.hennihaus.repositories.tables.StudentTableDescription.STUDENT_UPDATED_COLUMN
...
import de.hennihaus.repositories.tables.TeamTableDescription.TEAM_UPDATED_COLUMN
...
object TeamTable : UUIDTable(columnName = TEAM_UUID_COLUMN) {
    ...
    val updated = timestamp(name = TEAM_UPDATED_COLUMN)
}
...
object StudentTable : UUIDTable(columnName = STUDENT_UUID_COLUMN) {
    ...
    val updated = timestamp(name = STUDENT_UPDATED_COLUMN)
}
...
object StatisticTable : LongIdTable(columnName = STATISTIC_ID_COLUMN) {
    ...
    val updated = timestamp(name = STATISTIC_UPDATED_COLUMN)
}
...
object TeamTableDescription {
    ...
    const val TEAM_CREATED_COLUMN = "team_created_timestamp"
    const val TEAM_UPDATED_COLUMN = "team_updated_timestamp"
}
...
object StudentTableDescription {
    ...
    const val STUDENT_UPDATED_COLUMN = "student_updated_timestamp"
}
...
object StatisticTableDescription {
    ...
    const val STATISTIC_UPDATED_COLUMN = "statistic_updated_timestamp"
}
