...
object ExposedConfiguration {
    ...
    const val DATABASE_PROTOCOL = "exposed.protocol"
    const val DATABASE_HOST = "exposed.host"
    const val DATABASE_PORT = "exposed.port"
    const val DATABASE_NAME = "exposed.database"
    const val DATABASE_USER = "exposed.user"
    const val DATABASE_PASSWORD = "exposed.password"
