...
object ResponseObjectMother {
    ...
    const val BAD_REQUEST_EXAMPLE = "{\"reasons\": [{\"message\": \"password is required\", \"exception\": \"RequestValidationException\"}], \"dateTime\": \"2022-01-31T07:43:30Z\"}"
    ...
    const val NOT_FOUND_EXAMPLE = "{\"reasons\": [{\"message\": \"team not found by username and password\", \"exception\": \"NotFoundException\"}], \"dateTime\": \"2022-01-31T07:43:30Z\"}"
    ...
    const val INTERNAL_SERVER_ERROR_EXAMPLE = "{\"reasons\": [{\"message\": \"internal server error\", \"exception\": \"Exception\"}], \"dateTime\": \"2022-01-31T07:43:30Z\"}"
